...
class _AssessmentsState extends State<Assessments> {
  ...
  List<String> imagesAssessments = ['https://getthematic.com/insights/content/images/wordpress/2018/04/shutterstock_730381336.jpg',
  ...
  List<String> cardTitle = ['Self resilience survey','Perceived stress scale-\nStress in general',
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: Image.network(imagesAssessments[index]).image,
                        fit: BoxFit.cover
                    ),
                  ),
                  child: Container(
